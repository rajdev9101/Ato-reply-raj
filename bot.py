...
BOT_TOKEN = "7777252416:AAGG07twWDJjfFvldXqxaxrJmAFXa0yQAbA"  # 👈 Replace this
LOG_CHANNEL_ID = -1002391366258     # 👈 Replace this
...
async def fetch_channel_data(app):
    ...
    response_dict.clear()
    async for msg in app.bot.get_chat_history(chat_id=LOG_CHANNEL_ID, limit=100):
